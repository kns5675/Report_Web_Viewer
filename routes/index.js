...
// var xml = fs.readFileSync('xml/Sample03.xml', 'utf-8');
var xml = fs.readFileSync('xml/새리포트템플릿2.xml', 'utf-8');
...
var paramData = fs.readFileSync('xml/Sample03.xml', 'utf-8');
var paramTable = convert.xml2json(paramData, {compact : true});

//var SubReport = fs.readFileSync('xml/Sample01.xml', 'utf-8');
var SubReport = fs.readFileSync('xml/TestSample.xml', 'utf-8');
